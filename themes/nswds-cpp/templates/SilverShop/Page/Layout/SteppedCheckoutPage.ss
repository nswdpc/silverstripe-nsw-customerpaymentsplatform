    ...
    <div class="nsw-page-layout">
        ...
        <main id="main-content" class="nsw-page-layout__main">
            ...
            <% if $PaymentErrorMessage %>
                <% include nswds/InPageNotification InPageNotification_Icon='error', InPageNotification_Level='info', InPageNotification_Title='Payment error', InPageNotification_Content=$PaymentErrorMessage %>
            <% end_if %>
            ...
            <% else %>
                ...
                <% if $ContinueLink %>
                    ...
                    <% include nswds/Button Button_LinkURL=$ContinueLink, Button_ExtraClass='nsw-button--primary nsw-button--full-width', Button_Title='Continue Shopping' %>
